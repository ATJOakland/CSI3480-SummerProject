...
def user_Interface():
    ...
    elapsedTimeLabel.grid(column = 0, row = 2, pady = 3, padx = 3, columnspan = 2)
    ...
    attemptNumberLabel.grid(column = 0, row = 3, pady = 3, padx = 3, sticky="e")
    ...
    passwordDetectedLabel.grid(column = 0, row = 4, pady = 15, padx = 3, columnspan = 2)
